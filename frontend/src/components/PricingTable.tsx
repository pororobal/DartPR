...
const plans = [
  {
    ...
    features: [
      ...
      { label: "히스토리 조회", value: "가능 (3분 지연)", included: true },
      { label: "DVI 점수", value: "제공", included: true },
      { label: "실시간 (지연 없음)", value: false, included: false },
