    ...
    return (
      <span
        className={`inline-flex items-center justify-center font-mono font-bold rounded ${
          size === "sm" ? "text-xs px-1.5 py-0.5" : size === "lg" ? "text-lg px-3 py-1" : "text-sm px-2 py-0.5"
  ...
  return (
      <span
        className={`inline-flex items-center justify-center font-mono font-bold rounded ${colorClass} ${bgClass} ${
          size === "sm" ? "text-xs px-1.5 py-0.5" : size === "lg" ? "text-xl px-4 py-1.5" : "text-sm px-2 py-0.5"
        }`}
      >
        {Math.round(score)}
      </span>
